...
export const ChatMessageBubble = memo(function ChatMessageBubble({
  ...
  const _isMediaOnlyMessage = hasMediaAttachments && !hasTextContent
          ...
          >
            ...
            {!isOwn && (
              <UserAvatar
                ...
                avatar={message.User.image || message.User.avatar}
                size="sm"
                    ...
                    .map((attachment) => (
                      <div key={attachment.id} className="rounded-2xl overflow-hidden">
                        {attachment.type.startsWith('image/') ? (
                          <div
                            className="relative w-fit max-w-full cursor-pointer hover:opacity-90 transition-opacity"
                            onClick={() =>
