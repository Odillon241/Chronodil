                                        ...
                                        return (
                                            ...
                                            >
                                                <div className={cn("h-10 w-10 rounded-full shadow-inner flex items-center justify-center", color.class)}>
                                                    {isSelected && (
                                                        <Check className={cn("h-5 w-5", color.value === "dark" ? "text-white" : "text-gray-900")} />
                                                    )}
                                                </div>
                        ...
                        <CardHeader className="pb-3 border-b bg-background/50">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <CardDescription>Configurez votre langue, fuseau horaire et formats</CardDescription>
                                </div>
                                <Button
                                    variant="outline"
                                    size="sm"
                                    ...
                                    className="gap-2"
                                >
                                    {isDetecting ? <Loader2 className="h-4 w-4 animate-spin" /> : <Globe className="h-4 w-4" />}
                                    Détecter
                                </Button>
                            </div>
                        </CardHeader>
                        <CardContent className="p-0 bg-background/30">
                            <div className="grid md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-border/50">
                                ...
                                <div className="p-4">
                                    ...
                                    <Select value={settings.dateFormat} onValueChange={(v) => handleUpdate("dateFormat", v)}>
                                        <SelectTrigger disabled={isSaving}>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                                ...
                                <div className="p-4">
                                    ...
                                    <Select value={settings.hourFormat} onValueChange={(v) => handleUpdate("hourFormat", v)}>
                                        <SelectTrigger disabled={isSaving}>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                                ...
                                <div className="p-4">
                                    ...
                                    <Select value={settings.timezone} onValueChange={(v) => handleUpdate("timezone", v)}>
                                        <SelectTrigger disabled={isSaving}>
                                            <SelectValue />
                                        </SelectTrigger>
                                        <SelectContent>
                                ...
                                <div className="flex items-center justify-between p-4 hover:bg-muted/30 transition-colors">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">Augmente le contraste pour une meilleure lisibilité</p>
                                        </div>
                                    </div>
                                    <Switch
                                ...
                                <div className="flex items-center justify-between p-4 hover:bg-muted/30 transition-colors">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">Limite les animations pour le confort visuel</p>
                                        </div>
                                    </div>
                                    <Switch
