...
import { useNotificationSound, useAvailableSounds, CATEGORY_LABELS, NOTIFICATION_SOUNDS } from "@/hooks/use-notification-sound";
...
export default function NotificationsPage() {
    ...
    function SoundOptionCard({
        ...
        return (
            <div
                className={`flex items-center gap-4 p-2.5 rounded-xl transition-all ${isSelected
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center gap-2">
                        <Badge variant="outline" className="h-5 px-1.5 text-[10px] font-normal border-muted-foreground/20">
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="overflow-hidden border shadow-none bg-muted/20">
                            <CardHeader className="pb-3 border-b bg-background/50">
                                ...
                                <CardDescription>Activez ou désactivez les moyens de recevoir vos alertes</CardDescription>
                            </CardHeader>
                                    ...
                                    <div className="flex items-center justify-between p-4 hover:bg-muted/3 transition-colors">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-muted-foreground">Alertes sonores dans l'application</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            {preferences.notificationSoundEnabled && (
                                                <Badge variant="secondary" className="hidden sm:flex h-6 bg-green-500/10 text-green-600 dark:text-green-500 border-none">
                                                    {Math.round(localVolume)}%
                                                </Badge>
                                            )}
                                            <Switch
                                                checked={preferences.notificationSoundEnabled}
                                                onCheckedChange={(checked) => handleUpdatePreference("notificationSoundEnabled", checked)}
                                    ...
                                    <div className="flex items-center justify-between p-4 hover:bg-muted/3 transition-colors">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-muted-foreground">Récapitulatifs et alertes importantes par courriel</p>
                                            </div>
                                        </div>
                                        <Switch
                                            checked={preferences.emailNotificationsEnabled}
                                            onCheckedChange={(checked) => handleUpdatePreference("emailNotificationsEnabled", checked)}
                                            disabled={isSavingPreferences}
                                        />
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between p-4 hover:bg-muted/3 transition-colors">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-muted-foreground">Alertes système en temps réel sur votre ordinateur</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-3">
                                            ...
                                            <Switch
                                                ...
                                                onCheckedChange={(checked) => handleUpdatePreference("desktopNotificationsEnabled", checked)}
                                                disabled={isSavingPreferences}
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between p-4 hover:bg-muted/3 transition-colors">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-muted-foreground">Restez informé même quand l'onglet est fermé</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-3">
                                ...
                                <div className="grid gap-6 md:grid-cols-5 items-start">
                                    ...
                                    <div className="md:col-span-3 space-y-4">
                                        <div className="px-1">
                                            ...
                                            <p className="text-xs text-muted-foreground">Choisissez l'alerte sonore qui vous convient</p>
                                        </div>
                                                    ...
                                                    {isLoadingSounds ? (
                                                        ...
                                                        availableSounds.map((sound) => (
                                                            <SoundOptionCard
                                                                key={sound.id}
                                                                sound={sound}
                                                                isSelected={(preferences?.notificationSoundType ?? 'new-notification-3-398649') === sound.id}
                                    ...
                                    <div className="md:col-span-2 space-y-4">
                                        <div className="px-1">
                                            ...
                                            <p className="text-xs text-muted-foreground text-right md:text-left">Intensité des alertes</p>
                                        </div>

                                        <Card className="p-6 shadow-none bg-muted/5 border-none">
                                            <div className="space-y-8">
                                                <div className="flex items-center justify-between">
                                                    <div className={`p-4 rounded-full transition-all duration-300 ${localVolume === 0 ? 'bg-muted text-muted-foreground' : 'bg-primary/10 text-primary'}`}>
                                                        {localVolume === 0 ? (
                                                ...
                                                <div className="flex justify-between items-center bg-background p-2 rounded-lg border border-border/50">
                                                    <span className="text-[10px] font-bold text-muted-foreground px-2">TESTER</span>
                                                    <Button
                                                        size="sm"
                                                        onClick={async () => {
                                                            if (isTestingSound) return;
                                                            setIsTestingSound(true);
                                                            const currentSound = availableSounds.find(s => s.id === preferences?.notificationSoundType);
                                                            await testSound(currentSound || preferences?.notificationSoundType);
                                                            setIsTestingSound(false);
                                                        }}
                                                        className="h-8 px-4 rounded-md shadow-sm"
                                                    >
                                                        {isTestingSound ? <Spinner className="h-3 w-3" /> : <Volume2 className="h-3.5 w-3.5 mr-2" />}
                                                        Écouter
                                                    </Button>
                                                </div>
                                            </div>
