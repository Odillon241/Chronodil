                    ...
                    <TableCell className="py-3">
                      <div className="flex flex-col">
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          ...
                          {task.isShared && <Users className="h-3 w-3 text-blue-500" />}
                        </div>
                      </div>
                    </TableCell>
                        ...
                        {canModify ? (
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <Button
                                variant="ghost"
                                className="h-auto p-0 hover:bg-transparent hover:scale-105 transition-transform"
                              >
                            ...
                            <DropdownMenuContent align="start">
                              ...
                              <DropdownMenuSeparator />
                              {['TODO', 'IN_PROGRESS', 'REVIEW', 'DONE', 'BLOCKED'].map(
                                (status) => (
                                  <DropdownMenuItem
                                    key={status}
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="start">
                              ...
                              {['LOW', 'MEDIUM', 'HIGH', 'URGENT'].map((priority) => (
                                <DropdownMenuItem
                                  key={priority}
                                  onClick={() => onPriorityChange(task.id, priority as any)}
                                >
                      ...
                      <div className="flex justify-center -space-x-2 hovered-avatar-stack">
                        {task.TaskMember && task.TaskMember.length > 0 ? (
                          ...
                          <Button
                            variant="ghost"
                            size="icon"
                            className="h-8 w-8 rounded-full border border-dashed text-muted-foreground/50 hover:text-primary hover:border-primary/50"
                            title="Assigner"
                          >
