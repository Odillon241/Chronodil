...
>(({ className, ...props }, ref) => {
  return (
    <RadioGroupPrimitive.Item
      ...
      {...props}
    >
      <RadioGroupPrimitive.Indicator className="absolute inset-0 flex items-center justify-center after:content-[''] after:block after:h-2.5 after:w-2.5 after:rounded-full after:bg-current" />
    </RadioGroupPrimitive.Item>
  )
})
