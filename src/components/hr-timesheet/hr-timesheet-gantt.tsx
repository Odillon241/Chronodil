...
export function HRTimesheetGantt({ timesheets, onView, onAddNew }: HRTimesheetGanttProps) {
  ...
  const _groupedTimesheets = useMemo(() => groupTimesheetsBySite(timesheets), [timesheets])
  ...
  return (
    <div className="flex flex-col gap-4 border rounded-md p-4 bg-background">
      ...
      <div className="h-[600px] border rounded-md overflow-hidden relative">
        <GanttProvider range={range} zoom={zoom} onAddItem={onAddNew}>
          <GanttSidebar>
                        ...
                        >
                          <GanttFeatureItem {...feature}>
                            ...
                            <UserAvatar
                              ...
                              size="xs"
                              className="border border-background shrink-0"
                            />
                          </GanttFeatureItem>
                        </button>
                      )
