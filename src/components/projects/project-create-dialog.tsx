      ...
      <DialogContent className="max-w-[95vw] sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <form onSubmit={handleSubmit}>
          ...
          <div className="space-y-4 py-4">
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input id="create-name" name="name" placeholder="Ex: Refonte Site Web" required />
              </div>
              <div className="space-y-2">
                <Label htmlFor="create-code">Code *</Label>
                <Input id="create-code" name="code" placeholder="Ex: WEB-2024" required />
              </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input id="create-color" name="color" type="color" defaultValue="#dd2d4a" />
              </div>
            </div>
          ...
          <DialogFooter>
            ...
            <Button type="submit" className="bg-primary hover:bg-primary" disabled={submitting}>
              {submitting ? (
