...
export function QuietHoursSettings() {
  ...
  const _handleDayToggle = (day: string) => {
      ...
      <div className="md:col-span-2 space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Configurez une période pendant laquelle vous ne recevrez pas de notifications sonores ou
            de bureau.
          </p>
        </div>
        ...
        <div className="grid gap-6">
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50 transition-colors bg-card">
            ...
            <Switch id="quiet-hours-enabled" checked={enabled} onCheckedChange={setEnabled} />
          </div>
          ...
          {enabled && (
            <div className="animate-in fade-in slide-in-from-top-2 duration-300 space-y-6">
              ...
              >
                <div
                  className={`p-2 rounded-full ${isQuiet ? 'bg-blue-100 dark:bg-blue-900' : 'bg-primary/20 text-primary'}`}
                >
                  ...
                  <div className="flex flex-wrap gap-6">
                    <div className="space-y-2">
                      ...
                      <Select value={startTime} onValueChange={setStartTime}>
                        <SelectTrigger
                          id="start-time"
                          className="w-[140px] pl-9 font-medium relative"
                        >
                ...
                <div className="bg-muted/30 rounded-md p-4 border flex gap-3 items-start">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground leading-relaxed">
                      Le mode heures calmes s'activera automatiquement de{' '}
                      <span className="font-semibold text-foreground">{startTime}</span> à{' '}
        ...
        <div className="space-y-6">
          <div className="bg-muted/30 border rounded-lg p-5 space-y-4 sticky top-6">
            ...
            <div className="space-y-4 text-sm text-muted-foreground">
              <p>
                Le mode heures calmes vous permet de vous déconnecter en coupant automatiquement les
              ...
              <ul className="space-y-3">
                <li className="flex gap-2">
                  ...
                  <span>
                    <strong className="text-foreground block text-xs uppercase tracking-wide mb-0.5">
                      Notifications
                    </strong>
                    Elles continuent d'arriver dans votre centre de notifications mais ne sonnent
                    pas.
                  </span>
                </li>
                <li className="flex gap-2">
                  ...
                  <span>
                    ...
                    Les messages marqués comme "Urgent" pourront toujours émettre un son si
                    configuré.
                  </span>
                </li>
                <li className="flex gap-2">
                  ...
                  <span>
                    ...
                    Ajustez les jours pour désactiver ce mode automatiquement le week-end par
                    exemple.
                  </span>
                </li>
              </ul>
