  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row">
        {/* Image OpenGraph */}
        {data.image && (
          <div className="sm:w-1/3 aspect-video sm:aspect-square bg-muted shrink-0 relative">
            <Image
              src={data.image}
        ...
        <div className="flex-1 p-3 min-w-0">
          {/* Site name */}
          {data.siteName && (
            <div className="text-xs text-muted-foreground mb-1 truncate">{data.siteName}</div>
          )}
