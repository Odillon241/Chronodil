            ...
            {data.quickActions.length > 0 && (
              <CommandGroup heading="Actions & Navigation">
                {data.quickActions.map((action) => {
                  ...
                  return (
                    <CommandItem key={action.id} onSelect={() => navigate(action.path)}>
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-muted-foreground">
                          {new Date(ts.weekStartDate).toLocaleDateString('fr-FR')} - {ts.totalHours}
                          h
                        </span>
                      </div>
                    </CommandItem>
              ...
              <>
                ...
                <CommandGroup heading="Notifications">
                  {data.notifications.map((notif) => (
                    <CommandItem key={notif.id} onSelect={() => notif.link && navigate(notif.link)}>
