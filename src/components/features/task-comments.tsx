    ...
    <div className="space-y-4">
            ...
            {comments.map((comment) => (
              ...
              >
                <UserAvatar
                  ...
                  avatar={comment.User.image || comment.User.avatar}
                  size="sm"
                  className="shrink-0"
                />
                  ...
                  {editingId === comment.id ? (
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button size="sm" variant="destructive" onClick={handleCancelEdit}>
                          Annuler
                        </Button>
                      </div>
                    </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3 pt-4 border-t">
        ...
        <div className="flex justify-between items-center">
          <span className="text-xs text-muted-foreground">{newComment.length}/1000 caractères</span>
