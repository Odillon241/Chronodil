...
export function TaskList({ tasks, onEventClick, onEventDelete, onEventToggle }: TaskListProps) {
        ...
        return (
          <div key={status.id} className="space-y-3">
            ...
            <div className="flex items-center gap-3 sticky top-0 bg-background py-2 z-10">
              <div className="w-1 h-6 rounded-full" style={{ backgroundColor: status.color }} />
