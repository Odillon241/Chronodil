          ...
          .subscribe(async (status) => {
            ...
            if (status === 'SUBSCRIBED') {
              ...
              if (retryCountRef.current < maxRetries && isMountedRef.current) {
                ...
                console.log(
                  `⏳ Reconnexion dans ${delay}ms (tentative ${retryCountRef.current + 1}/${maxRetries})`,
                )
                ...
                console.warn(
                  '❌ Nombre maximum de tentatives de reconnexion atteint. La présence en temps réel est désactivée.',
                )
              }
            }
          })
